...
## Saída
Exiba a mensagem conforme o exemplo de saída abaixo, sendo uma mensagem por linha e não esquecendo o final de linha após cada uma. Mala Suerte" se N é de má sorte, caso contrário imprima "N NO es de Mala Suerte".